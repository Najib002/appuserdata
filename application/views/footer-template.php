        <footer class="footer bg-dark">
            <span class="d-none d-sm-inline-block text-white font-weight-bold">© <?= date('Y');?> <?= $footer;?></span>
        </footer>
        ...
        <script src="<?php echo base_url();?>assets/assets/pages/datatables.init.js"></script>
        <script src="<?php echo base_url();?>assets/assets/js/app.js"></script>
        <script src="<?php echo base_url();?>assets/plugins/peity/jquery.peity.min.js"></script>
        <script src="<?php echo base_url();?>assets/plugins/morris/morris.min.js"></script>
        <script src="<?php echo base_url();?>assets/plugins/raphael/raphael-min.js"></script>
        <script src="<?php echo base_url();?>assets/assets/pages/dashboard.js"></script>
